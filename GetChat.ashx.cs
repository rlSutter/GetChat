...
namespace GetChat
{
    ...
    public class GetChat : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // Web Service 
            YourNamespace.YourWebService.Service wsvcs = new YourNamespace.YourWebService.Service();
            ...
            // ============================================
            // Get system defaults
            ConnectionStringSettings connSettings = ConfigurationManager.ConnectionStrings["YourConnectionStringName"];
            ...
            if (ConnS == "")
            {
                ConnS = "server=YOUR_SERVER\\YOUR_INSTANCE;uid=YOUR_USER;pwd=YOUR_PASSWORD;database=YOUR_DATABASE";
            }
            ...
            try
            {
                string Jsonfile = "C:\\Logs\\GetChat-JSON.log"; // Update path as needed
            ...
            {
                logfile = "C:\\Logs\\GetChat.log"; // Update path as needed
                try
                {
            ...
            string emailAddress = "techsupport@yourdomain.com";
            ...
            if (emailAddress != "")
            {
                    ...
                    if (dr.HasRows)
                    {
                        while (dr.Read())
                        {
                            if (dr[0] == DBNull.Value) {
                                if (DeptName == "Sales") { EmpId = "YOUR_SALES_EMP_ID"; } else { EmpId = "YOUR_TECH_EMP_ID"; }
                            } else { EmpId = dr[0].ToString(); }
                            if (dr[1] == DBNull.Value) {
                                if (DeptName == "Sales") { EmpLogin = "YOUR_SALES_LOGIN"; } else { EmpLogin = "YOUR_TECH_LOGIN"; } 
                ...
                if (EmpId == "") {
                    if (DeptName == "Sales") { 
                        EmpId = "YOUR_SALES_EMP_ID";
                        EmpLogin = "YOUR_SALES_LOGIN";
                    } else { 
                        EmpId = "YOUR_TECH_EMP_ID";
                        EmpLogin = "YOUR_TECH_LOGIN";
                    }
                }
                if (Debug == "Y")
                {
...
GenActivity:
            ...
            SqlS = "INSERT INTO yourdb.dbo.S_EVT_ACT " +
